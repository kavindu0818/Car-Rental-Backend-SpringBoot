...
public class BookingHistoryController {
    ...
    public ResponseEntity<?> addBookingHistory(@RequestBody BookingHistoryDto bookingHistoryDto) {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Error adding booking history: " + ex.getMessage());
        }
    ...
    public ResponseEntity<String> deleteCar(@PathVariable String id) {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Error deleting booking: " + ex.getMessage());
        }
